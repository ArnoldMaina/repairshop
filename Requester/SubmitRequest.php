...
if(isset($_REQUEST['submitrequest'])){
 ...
 if(($_REQUEST['requestinfo'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || ($_REQUEST['requesteradd1'] == "") || ($_REQUEST['requesteradd2'] == "") || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterzip'] == "") || ($_REQUEST['requesteremail'] == "") || ($_REQUEST['requestermobile'] == "") || ($_REQUEST['requestdate'] == "")){
  ...
  $msg = '<div class="alert alert-warning col-sm-6 ml-5 mt-2" role="alert"> Fill All Fileds </div>';
   ...
   $sql = "INSERT INTO submitrequest_tb_new(request_info, request_desc, requester_name, requester_add1, requester_add2, requester_district, requester_div, requester_zip, requester_email, requester_mobile, request_date) VALUES ('".addslashes($rinfo)."','".addslashes($rdesc)."', '".addslashes($rname)."', '".addslashes($radd1)."', '".addslashes($radd2)."', '".addslashes($rcity)."', '".addslashes($rstate)."', '$rzip', '$remail', '$rmobile', '$rdate')";
  ...
  <form class="mx-5" action="" method="POST">
    ...
    <div class="form-row">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="inputAddress2" placeholder="Moi ave" name="requesteradd2">
      </div>
    </div>
    <div class="form-row">
      <div class="form-group col-md-6">
