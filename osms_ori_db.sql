...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2022 at 09:37 PM
...
(1, 'Admin1', 'arnoldmaina97@gmail.com@gmail.com', 'Eckounlimitedosms1');
...
(127, 'ARNOLD MAINA', 'anmaina1@gmail.com', '12345678');
...
(53, 'ARNOLD MAINA', 'NAIROBI', 718883082, 'arnoldmaina97@gmail.com'),
(54, 'Dan Muigai', 'NAIROBI', 740611883, 'tech1@etrreapairs.com'),
(55, 'Innocent Amoth', 'NAIROBI', 712174017, 'tech2@etrrepairs.com');
...
--
ALTER TABLE `technician_tb`
  MODIFY `empid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
COMMIT;
